...
public class Instrucciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Instrucciones\n\n-Ingrese una reaccion con un espacio entre cada\n compuesto\n-Ingresa los elementos con mayusculas y minusculas\n-No ingrese signos de mas\n-Da click en el boton de calcular para saber su \n Redox\n-Da click en limpiar para vaciar los campos\n\n");
